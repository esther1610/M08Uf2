...
class CameraFotos : AppCompatActivity() {

    private  lateinit var binding: ActivityCameraFotosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCameraFotosBinding.inflate(layoutInflater)
        setContentView(binding.root)
        // Requereix permissos de càmera
